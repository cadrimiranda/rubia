    ...
    <div className="flex bg-neutral-100 p-1" style={{ borderRadius: "100px" }}>
      {tabs.map((tab) => {
        ...
        const getButtonClass = () => {
          let baseClass =
            "h-8 px-3 text-sm font-medium transition-all duration-200 flex items-center gap-1 flex-1 justify-center";

          if (isActive) {
            baseClass += " bg-white text-blue-500 shadow-sm";
          } else {
            baseClass +=
              " bg-transparent text-neutral-600 hover:text-neutral-700 hover:bg-neutral-200/50";
          }
